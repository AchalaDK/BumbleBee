 ...
 * 
 */
@WebServiceClient(name = "AdminService", targetNamespace = "http://Services/", wsdlLocation = "http://localhost:8080/BumbelBee-Admin-Services/AdminService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/BumbelBee-Admin-Services/AdminService?wsdl");
    ...
    public AdminService getAdminServicePort() {
        return super.getPort(new QName("http://Services/", "AdminServicePort"), AdminService.class);
    }
    ...
    public AdminService getAdminServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://Services/", "AdminServicePort"), AdminService.class, features);
    }
