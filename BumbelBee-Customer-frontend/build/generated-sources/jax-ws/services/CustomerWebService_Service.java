 ...
 * 
 */
@WebServiceClient(name = "CustomerWebService", targetNamespace = "http://Services/", wsdlLocation = "http://localhost:8080/BumbelBee-Customer-Services/CustomerWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CUSTOMERWEBSERVICE_QNAME = new QName("http://Services/", "CustomerWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/BumbelBee-Customer-Services/CustomerWebService?wsdl");
    ...
    public CustomerWebService getCustomerWebServicePort() {
        return super.getPort(new QName("http://Services/", "CustomerWebServicePort"), CustomerWebService.class);
    }
    ...
    public CustomerWebService getCustomerWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://Services/", "CustomerWebServicePort"), CustomerWebService.class, features);
    }
